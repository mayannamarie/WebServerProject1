...
22. Save your httpd.conf and test the updates in the command line by typing the following:

23. cd into **C:\Apache24\bin**
type: httpd -t
24. Syntax OK should appear … unless you have errors in your configuration.
